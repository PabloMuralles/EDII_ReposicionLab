...
namespace LabReposicion.Transposicion
{
    public class Cesar
    {
        ...
        public void CifrarMensaje(string RutaAchivos, string ArchivoLeido)
        {
        ...
        public void DecifrarMensaje(string RutaAchivos, string ArchivoLeido)
        {
            RutaUsuario = RutaAchivos;
            generarDiccionarioOriginal();
            generarDiccionarioCifrado(clave);
        ...
        public void ObtenerTextoArchivoOriginal(string archivoLeido)
        {
            ...
            if (!Directory.Exists(Path.Combine(CarpetaCompress, "CipherCesar")))
            {
                Directory.CreateDirectory(Path.Combine(CarpetaCompress, "CipherCesar"));
            }
            using (var writeStream = new FileStream(Path.Combine(CarpetaCompress, "CipherCesar", $"{RutaUsuario}.txt"), FileMode.OpenOrCreate))
            {
        ...
        public void ObtenerTextoArchivoDecifrado(string archivoLeido)
        {
            ...
            if (!Directory.Exists(Path.Combine(CarpetaCompress, "DecipherCesar")))
            {
                Directory.CreateDirectory(Path.Combine(CarpetaCompress, "DecipherCesar"));
            }
